...
=== Basic Configuration
* Add :shipper and / or :indexer to your server configuration. Use :combined if the server is both a indexer and a shipper
  <tt>server 'my-indexer-server', :app, :god, :indexer, :web, :db, :primary => true</tt>
  <tt>server 'my-shipping-server', :app, :god, :shipper, :web, :db, :primary => true</tt>
  <tt>server 'my-indexer-shipping-server', :app, :god, :combined, :web, :db, :primary => true</tt>
